...
if (t_test_object$p.value < 0.05) {
  print("")
  print("There is evidence of a salary difference between the two same_state groups.")
} else {
  print("")
  print("There is not enough evidence to say that average salary differs by same_state.")
}
