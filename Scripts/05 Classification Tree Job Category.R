...
print("")
print(paste0("Classification accuracy: ", format_number(classification_accuracy, 3)))
print("")
print(paste0("Classification note: ", classification_salary_note))
print("")
print("Class-level metrics:")
print(classification_metrics_table)
print("")
print("Most important tree variables:")
