...
writeLines("")
writeLines("Classification class counts:")
print(class_counts_table)
writeLines("")
writeLines(paste0("Classification accuracy: ", format_number(classification_accuracy, 3)))
writeLines("")
writeLines(paste0("Classification note: ", classification_salary_note))
writeLines("")
writeLines("Class-level metrics:")
print(classification_metrics_table)
writeLines("")
writeLines("Most important tree variables:")
